...
#		print 'flag:',flag
               	...
               	packetlossmin = bernum/(1460*8)+1
#		print 'min:',packetlossmin
		packetlossmax = min(bernum,100)
#		print 'max:',packetlossmax
		packetlossavg = (packetlossmin + packetlossmax)/2
#		print 'avg:',packetlossavg
#		print 'pklavg:',packetlossavg,'%'
#		print Delay[flag]
#		print type(Delay[flag])
		os.system('tc qdisc del dev tap7cd37a48-e4 root')
		os.system('tc qdisc add dev tap7cd37a48-e4 root netem  delay '+str(Delay[flag])+'ms loss '+str(packetlossavg)+'%')
		res = Remotessh()
		print 'Delay:'+str(Delay[flag]),'BER:'+str(i),' Sent 100 packets,'+res
		flag = flag + 1
	os.system('tc qdisc del dev tap7cd37a48-e4 root')
